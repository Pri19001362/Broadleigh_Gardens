<?php
  ...
  if ($_SERVER['REQUEST_METHOD'] == 'POST')
  {
    ...
    $lname =  InputProcessor::processString($_POST['lname']);
    $uname =  InputProcessor::processString($_POST['uname']);
        ...
        <div class="col-12 col-md-8 col-lg-6 col-xl-5">
          <div class="card shadow-2-strong" style="border-radius: 1rem;">
            <div class="card-body p-5 text-center">
              ...
              <div class="form-outline mb-4">
                <input required type="text" id="lname" name="lname" class="form-control form-control-lg" placeholder="Lastname" value="<?= htmlspecialchars($lname['value'] ?? '') ?>"/>
                <small class="text-danger"><?= htmlspecialchars($lname['error'] ?? '') ?></small>
              </div>

              <div class="form-outline mb-4">
                <input required type="text" id="uname" name="uname" class="form-control form-control-lg" placeholder="Username" value="<?= htmlspecialchars($uname['value'] ?? '') ?>"/>
